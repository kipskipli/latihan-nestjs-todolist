import { Body, Controller, Get, Header, Post, Req, Res, Response, UseGuards } from '@nestjs/common';
...
export class AppController {
  constructor(private readonly appService: AppService, private jwtService: InspigoJwtService) {}
